                ...
                style={({ pressed }) => [
                    ...
                    styles.shadow,
                    {
                        backgroundColor: disabled
                            ...
                            : (isChatButton && timeLeft === 0 ? buttonBgColor : backgroundColor),
                        borderColor: borderColor,
                        paddingHorizontal: isOption ? 25 : undefined,
                        alignItems: isOption ? undefined : 'center',
                        transform: [{ scale: pressed ? 0.97 : 1 }], // scale smaller when pressed
                    },
                ]}
            >
                <Text
                    style={[
                        styles.buttonText,
                        {
                            color: disabled
                                ? '#A0A0A0'
                                : (isChatButton && timeLeft === 0 ? textColor : labelColor),
                            textTransform: textStyle,
                        },
                    ]}
                >
