...
export default function LearnerAssessmentExperience() {
    ...
    const barriers: string[] = ['Time', 'Resources', 'Accessibility', 'Interest'];
        ...
        <View style={{ padding: 20, flex: 1, backgroundColor: "#FFFFFF" }}>
            <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ marginTop: 5 }}>
                    <ChatBubble position='left'>What are some factors that affect your learning experience?</ChatBubble>
                </View>
            </View>
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 2.3, borderWidth: 1, borderColor: !isContinue && !selectedAttitude ? '#ff4c4c' : '#9CA3AF', borderRadius: 10 }}>
                        ...
                        >
                            <Picker.Item style={styles.defaultOptionText} label="Select Attitude Towards Learning" value="" enabled={false} />
                            {attitude.map((value) => (
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 2.3, borderWidth: 1, borderColor: !isContinue && !selectedMotivation ? '#ff4c4c' : '#9CA3AF', borderRadius: 10 }}>
                        ...
                        >
                            <Picker.Item style={styles.defaultOptionText} label="Select Motivational Level" value="" enabled={false} />
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={[styles.text, { flex: 1, marginTop: 5 }]}>Learning {'\n'}Barriers</Text>
                    <View style={{ flex: 2.3 }}>
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 2.3, borderWidth: 1, borderColor: !isContinue && !selectedPersonality ? '#ff4c4c' : '#9CA3AF', borderRadius: 10 }}>
                        ...
                        >
                            <Picker.Item style={styles.defaultOptionText} label="Select Personality" value="" enabled={false} />
            ...
            <View style={{ marginTop: 20 }}>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={[styles.text, { flex: 1, marginTop: 5 }]}>Reasons For {'\n'}Attending Course</Text>
                    <View style={{ flex: 2.3 }}>
                        {reasons.map((reason) => (
                            <TouchableOpacity
                                key={reason}
