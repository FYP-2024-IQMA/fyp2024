  ...
  return (
    <View style={{ padding: 20, flex: 1, backgroundColor: "#FFFFFF" }}>
      <View style={{ flexDirection: "row" }}>
        <Image
          style={{ height: 150, width: 50, marginRight: 40, marginLeft: 20 }}
          source={require("@/assets/images/handsinpocket.png")}
        />
        <View style={{ marginTop: 5 }}>
          <ChatBubble position="left">
            What are some factors that affect your learning experience?
          </ChatBubble>
        </View>
      </View>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedAttitude ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedMotivation ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedPersonality ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
            ...
            {reasons.map((reason) => (
              ...
              >
                <View
                  style={[
                    styles.checkbox,
                    selectedReasons.includes(reason) && styles.checkedCheckbox,
                    {
                      borderColor:
