        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedPeers ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedTendency ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedSocial ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedComputer ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
