        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <View
            style={{
              flex: 2.5,
              borderWidth: 1,
              borderColor: !isContinue && !selectedRace ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              flex: 2.5,
              borderWidth: 1,
              borderColor: !isContinue && !selectedJob ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              flex: 2.5,
              borderWidth: 1,
              borderColor: !isContinue && !selectedLife ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              ...
              borderWidth: 1,
              borderColor:
                !isContinue && !selectedCareer ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
        ...
        >
          ...
          <View
            style={{
              flex: 2.5,
              borderWidth: 1,
              borderColor: !isContinue && !selectedNeed ? "#ff4c4c" : "#9CA3AF",
              borderRadius: 10,
            }}
          >
            <Picker
