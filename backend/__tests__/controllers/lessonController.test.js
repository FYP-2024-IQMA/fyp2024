...
describe("GET /lessons/getnumberoflessons/:sectionID/:unitID", () => {
    it("should return the number of lessons in a unit", async () => {
        ...
        const response = await request(app).get("/lessons/getnumberoflessons/SEC0001/UNIT0001");
...
describe("GET /lessons/getlesson/:sectionID/:unitID/:lessonID", () => {
    const mockLesson = {
        sectionID: "SEC0001",
        unitID: "UNIT0001",
        lessonID: "1a",
        lessonCheatSheet: {
            "🗣️ Verbal Signals:": "🎶 Tone of Voice: Emotions can be conveyed through variations in pitch, volume, and intonation.",
        },
    };
    ...
    it("should return a lesson by ID", async () => {
        ...
        const response = await request(app).get("/lessons/getlesson/SEC0001/UNIT0001/1a");
...
describe("GET /lessons/getalllessons/:sectionID/:unitID", () => {
    const mockLessons = [
        [
            {
                "sectionID": "SEC0001",
    ...
    it("should return all lessons for a unit", async () => {
        ...
        const response = await request(app).get("/lessons/getalllessons/SEC0001/UNIT0001");
