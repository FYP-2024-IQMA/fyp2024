...
describe("getLesson", () => {
    ...
    const mockResult = {
        ...
        lessonCheatSheet: {
            ...
            "👁️ Non-verbal Signals:": "🕺 Body Language: Posture, gestures, and facial expressions can speak volumes without saying a word.\r\n👀 Eye Contact: The level of eye contact can convey confidence, interest, or discomfort.\r\n🌍 Personal Space: Respect for personal space varies across cultures and can affect communication dynamics."
        },
        dateCreated: "2024-08-18T14:59:11.210043+00:00"
    };

    it("should return a lesson with properly formatted cheat sheet", async () => {
        const mockEq3 = jest.fn().mockResolvedValue({ data: [mockLesson], error: null });
        ...
        // Call the service function
        const result = await lessonService.getLesson("SEC0001", "UNIT0001", "1a");
